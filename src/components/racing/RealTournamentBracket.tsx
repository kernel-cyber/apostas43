                  ...
                  {position.pilot ? (
                    <div className="text-center space-y-1">
                      ...
                      {position.pilot.image_url && (
                        <div className="w-20 h-20 rounded-full overflow-hidden mb-2 bg-muted/30 border-2 border-primary/30 mx-auto">
                          <img
                      ...
                      {position.pilot.team && (
                        <p className="text-[10px] text-blue-400 break-words">
                          🏁 {position.pilot.team}
                        </p>
                      )}
                    </div>
