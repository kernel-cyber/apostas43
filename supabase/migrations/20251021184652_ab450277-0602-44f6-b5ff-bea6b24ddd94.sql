-- Corrigir função settle_match para distribuir pontos corretamente baseado no pool
...
BEGIN
  ...
  -- Se houver apostas no vencedor, distribuir o pool total proporcionalmente
  IF v_winner_pool > 0 THEN
    ...
    LOOP
      -- Retornar a aposta + ganho proporcional do pool dos perdedores
      UPDATE user_points
